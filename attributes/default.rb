...
default['bind']['defaultfile'] = '/etc/sysconfig/named'
...
when 'debian'
  ...
  default['bind']['defaultfile'] = '/etc/default/bind9'
...
default['bind']['zones']['email'] = 'hostmaster.example.com.'
default['bind']['zones']['nsmaster'] = 'ns.example.com'
default['bind']['zones']['nsmaster_ip'] = '127.0.0.1'
default['bind']['zones']['ttl'] = 86_400
default['bind']['zones']['refresh'] = 604_800
default['bind']['zones']['retry'] = 86_400
default['bind']['zones']['expire'] = 2_419_200
default['bind']['zones']['minimum'] = 86_400
